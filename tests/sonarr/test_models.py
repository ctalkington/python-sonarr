...
CALENDAR = json.loads(load_fixture("sonarr/calendar.json"))
QUEUE = json.loads(load_fixture("sonarr/queue.json"))
SERIES = json.loads(load_fixture("sonarr/series.json"))
WANTED = json.loads(load_fixture("sonarr/wanted-missing.json"))
